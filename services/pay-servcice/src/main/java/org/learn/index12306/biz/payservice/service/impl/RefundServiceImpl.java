...
import org.learn.index12306.biz.payservice.convert.RefundRequestConvert;
import org.learn.index12306.biz.payservice.dao.entity.PayDO;
import org.learn.index12306.biz.payservice.dao.entity.RefundDO;
import org.learn.index12306.biz.payservice.dao.mapper.PayMapper;
import org.learn.index12306.biz.payservice.dao.mapper.RefundMapper;
import org.learn.index12306.biz.payservice.dto.*;
...
import org.learn.index12306.biz.payservice.mq.produce.RefundResultCallbackOrderProduce;
import org.learn.index12306.biz.payservice.remote.TicketOrderRemoteService;
...
public class RefundServiceImpl implements RefundService {
    ...
    private final RefundResultCallbackOrderProduce refundResultCallbackOrderProduce;

    @Override
    public RefundRespDTO refund(RefundReqDTO requestParam) {
        ...
        LambdaUpdateWrapper<PayDO> updateWrapper = Wrappers.lambdaUpdate(PayDO.class)
                .eq(PayDO::getOrderSn, requestParam.getOrderSn());
        int inserted = payMapper.update(payDO, updateWrapper);
        if(inserted <= 0 ){
        ...
        if(Objects.equals(result.getStatus(), TradeStatusEnum.TRADE_CLOSED.tradeCode())){
            RefundResultCallbackOrderEvent refundResultCallbackOrderEvent = RefundResultCallbackOrderEvent.builder()
                    ...
                    .build();
            refundResultCallbackOrderProduce.sendMessage(refundResultCallbackOrderEvent);
        }
