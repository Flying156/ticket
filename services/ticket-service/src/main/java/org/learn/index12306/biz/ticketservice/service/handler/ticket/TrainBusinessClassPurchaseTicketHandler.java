package org.learn.index12306.biz.ticketservice.service.handler.ticket;
...
import org.learn.index12306.biz.ticketservice.service.handler.ticket.base.AbstractTrainPurchaseTicketTemplate;
import org.learn.index12306.biz.ticketservice.service.handler.ticket.base.BitMapCheckSeat;
import org.learn.index12306.biz.ticketservice.service.handler.ticket.base.BitMapCheckSeatStatusFactory;
...
import org.learn.index12306.biz.ticketservice.service.handler.ticket.select.SeatSelection;
import org.learn.index12306.biz.ticketservice.toolkit.CarriageVacantSeatCalculateUtil;
import org.learn.index12306.biz.ticketservice.toolkit.SeatNumberUtil;
...
import static org.learn.index12306.biz.ticketservice.service.handler.ticket.base.BitMapCheckSeatStatusFactory.TRAIN_BUSINESS;

/**
 * 高铁商务等座购票组件
 *
 * @author Milk
 * @version 2023/10/14 10:59
 */
@Component
