package org.learn.index12306.biz.ticketservice.job;
...
import org.learn.index12306.biz.ticketservice.job.base.AbstractTrainStationJobHandlerTemplate;
...
import org.learn.index12306.biz.ticketservice.dao.entity.TrainStationRelationDO;
...
import static org.learn.index12306.biz.ticketservice.common.constant.RedisKeyConstant.REGION_TRAIN_STATION;

/**
 * 地区站点查询定时任务
 *
 * @author Milk
 * @version 2023/11/2 20:32
 */
@RestController
@RequiredArgsConstructor
public class RegionTrainStationJobHandler extends AbstractTrainStationJobHandlerTemplate {
        ...
        for(int i = 0; i < regionList.size(); i++){
            for(int j = 0; j < regionList.size(); j++){
                if(i != j){
                    ...
                    if(CollUtil.isNotEmpty(trainStationRelationDOList)){
                        continue;
                    }
