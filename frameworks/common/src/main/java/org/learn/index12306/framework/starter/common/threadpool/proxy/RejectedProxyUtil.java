...
import org.learn.index12306.framework.starter.common.toolkit.ThreadUtil;
...
public final class RejectedProxyUtil {
    ...
    public static void main(String[] args) {
        ThreadPoolExecutor threadPoolExecutor =
                new ThreadPoolExecutor(1, 4, 1024, TimeUnit.SECONDS, new LinkedBlockingQueue<>(1));
