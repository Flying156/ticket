...
package org.learn.index12306.framework.starter.distributedid.core.serviceid;
...
public interface ServiceIdGenerator extends IdGenerator {
     ...
     */
    default long nextId(long serviceId){return 0L;}
    ...
    /**
     * 根据 {@param serviceId} 生成字符串型雪花算法 ID
     */
